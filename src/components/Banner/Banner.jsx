      ...
      <div className="bg-[#f9f9f9] grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 py-14">
        ...
        <div className="flex justify-center items-start">
          <motion.img
            ...
            src={image}
            alt=""
            className="w-[300px] md:max-w-[400px] xl:min-w-[600px] h-full object-cover z-5"
          />
        </div>
        {/* Banner Text Caption Section */}
        <div className="flex flex-col justify-center text-center md:text-left space-y-4 lg:max-w-[500px] z-10">
          <motion.p
